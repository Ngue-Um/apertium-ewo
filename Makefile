...
pkgdatadir = $(datadir)/apertium-ewo
pkgincludedir = $(includedir)/apertium-ewo
pkglibdir = $(libdir)/apertium-ewo
pkglibexecdir = $(libexecdir)/apertium-ewo
...
CONFIG_CLEAN_FILES = apertium-ewo.pc
...
am__installdirs = "$(DESTDIR)$(apertium_ewodir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_ewo_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-ewo.pc.in \
...
ACLOCAL = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/include/apertium-3.8 -I/usr/lib/x86_64-linux-gnu/apertium-3.8/include
APERTIUM_LIBS = -lapertium3
AUTOCONF = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/missing autoconf
AUTOHEADER = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/missing autoheader
AUTOMAKE = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/missing automake-1.16
AWK = gawk
CG3_CFLAGS = -I/usr/include/
CG3_LIBS = -lcg3
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Ewondo\" -DPACKAGE_TARNAME=\"apertium-ewo\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Ewondo\ 0.1.0\" -DPACKAGE_BUGREPORT=\"ngueum@gmail.com\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-ewo\" -DPACKAGE=\"apertium-ewo\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HFSTOSPELL_CFLAGS = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
PACKAGE = apertium-ewo
PACKAGE_BUGREPORT = ngueum@gmail.com
PACKAGE_NAME = Apertium Ewondo
PACKAGE_STRING = Apertium Ewondo 0.1.0
PACKAGE_TARNAME = apertium-ewo
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-ewo
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/ngotjomb/apertium_ewo_fra/apertium-ewo
abs_srcdir = /home/ngotjomb/apertium_ewo_fra/apertium-ewo
abs_top_builddir = /home/ngotjomb/apertium_ewo_fra/apertium-ewo
abs_top_srcdir = /home/ngotjomb/apertium_ewo_fra/apertium-ewo
am__leading_dot = .
...
install_sh = ${SHELL} /home/ngotjomb/apertium_ewo_fra/apertium-ewo/install-sh
...
$(am__aclocal_m4_deps):
apertium-ewo.pc: $(top_builddir)/config.status $(srcdir)/apertium-ewo.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_ewoDATA: $(apertium_ewo_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ewo_DATA)'; test -n "$(apertium_ewodir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_ewodir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_ewodir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_ewodir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_ewodir)" || exit $$?; \
	done

uninstall-apertium_ewoDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ewo_DATA)'; test -n "$(apertium_ewodir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_ewodir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_ewodir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_ewoDATA install-data-local \
...
uninstall-am: uninstall-apertium_ewoDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_ewoDATA install-data \
	...
	uninstall-am uninstall-apertium_ewoDATA \
	uninstall-pkgconfigDATA
